...
class TimelineTest(unittest.TestCase):
    ...
    FIRST_POST = retrieve_timeline.PostDto(id=FIRST_POST_ID, user_id=USER_ID, text=TEXT, created_on=DATETIME)
    SECOND_POST = retrieve_timeline.PostDto(id=SECOND_POST_ID, user_id=USER_ID, text=TEXT, created_on=LATER_DATETIME)
